    ...
    <main>
        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-6xl">
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-muted-foreground font-light">No dispatches published yet — check back soon for in-depth analysis.</p>
            </div>
          ) : (
            <div className="grid lg:grid-cols-3 gap-8">
              {items.map((item) => (
      ...
      <section className="py-28 lg:py-32 bg-primary">
        <div className="container mx-auto px-6 lg:px-12 text-center max-w-3xl">
          <h2 className="font-display text-4xl md:text-5xl text-primary-foreground mb-6 leading-[1.1] tracking-tight">Want analysis on a specific topic?</h2>
          <p className="text-primary-foreground/70 text-lg mb-10 font-light leading-relaxed">Get in touch to discuss commissioned research and analytical work.</p>
