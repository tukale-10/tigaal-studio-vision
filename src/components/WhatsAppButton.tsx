...
export const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed bottom-5 right-5 md:bottom-6 md:right-6 z-[9999] flex items-center gap-2">
      {/* Tooltip */}
      <span
        className={`
          hidden md:block
          bg-gray-900 text-white text-sm font-medium px-3 py-1.5 rounded-lg shadow-lg
